...
uses
  ...
  System.SysUtils,
  uCEFApplication,
  uWenkuBrowser in 'uWenkuBrowser.pas' {MiniBrowserFrm},
  uPreferences in 'uPreferences.pas' {PreferencesFrm},
  uSimpleTextViewer in 'uSimpleTextViewer.pas' {SimpleTextViewerFrm},
  HtmlParserEx in '..\ThirdPart\HtmlParserEx\HtmlParserEx.pas';
...
begin
  ...
  GlobalCEFApp.ShutdownWaitTime           := 2000;
